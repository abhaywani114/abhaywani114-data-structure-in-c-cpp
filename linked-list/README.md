...
- **Linked List P2:** demonstrating an *int list* implementation as using linked list that should be capable to `insert`, `remove` `print`, and, `reverse` elements using C++.
